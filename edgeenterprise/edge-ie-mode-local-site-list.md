---
title: Lokale Websiteliste für den Internet Explorer (IE)-Modus
ms.author: shisub
author: dan-wesley
manager: srugh
ms.date: 11/15/2021
...
> [!IMPORTANT]
> Dieses Feature für lokale Websitelisten wird derzeit für Windows Server 2016 nicht unterstützt.
...
> [!NOTE]
> Eine *nicht konfigurierte* Website ist eine Website, die den IE-Modus erfordert, aber nicht für das Öffnen im IE-Modus in der Enterprise Mode Site List konfiguriert ist.
...
Nachdem eine Website im IE-Modus neu geladen wurde, verbleibt die "Seitennavigation" im IE-Modus (z. B. ein Link, ein Skript, ein Formular auf der Seite oder eine serverseitige Umleitung von einer anderen "seiteninternen" Navigation).  
...
- Deaktivieren von Internet Explorer 11 – [Deaktivieren von Internet Explorer 11](/deployedge/edge-ie-disable-ie11)
- Konfigurieren von IE-Modusrichtlinien – [Konfigurieren von IE-Modusrichtlinien](/deployedge/edge-ie-mode-policies)
