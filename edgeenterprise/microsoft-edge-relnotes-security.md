...
## <a name="april-7-2022"></a>7. April 2022

Microsoft hat den neuesten **Microsoft Edge Stable Channel (Version 100.0.1185.36) veröffentlicht**, der die neuesten Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Leitfaden für Sicherheitsupdates](https://msrc.microsoft.com/update-guide).

## <a name="april-1-2022"></a>1. April 2022

Microsoft hat den neuesten **Microsoft Edge Stable Channel (Version 100.0.1185.29)** veröffentlicht, der die neuesten Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).

Dieses Update enthält die folgenden, Microsoft Edge-spezifischen Updates:
...
## <a name="march-26-2022"></a>26. März 2022

Microsoft hat den neuesten  **Microsoft Edge Stable Channel (Version 99.0.1150.55) **veröffentlicht, der die neuesten Sicherheitsupdates des Chromium-Projekts enthält. Dieses Update enthält eine Korrektur für [CVE-2022-1096](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-1096), die vom Chromium-Team als eine Sicherheitslücke in freier Wildbahn gemeldet wurde. Weitere Informationen finden Sie im [Leitfaden zu Sicherheitsupdates](https://msrc.microsoft.com/update-guide).

## <a name="march-17-2022"></a>17. März 2022

Microsoft hat den neuesten  **Microsoft Edge Stable Channel (Version 99.0.1150.46) **veröffentlicht, der die neuesten Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).
...
## <a name="march-3-2022"></a>3. März 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version99.0.1150.30)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Leitfaden für Sicherheitsupdates](https://msrc.microsoft.com/update-guide).

## <a name="february-16-2022"></a>16. Februar 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version98.0.1108.55)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Dieses Update enthält eine Korrektur für [CVE-2022-0609](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-0609), die vom Chromium-Team als eine Sicherheitslücke in freier Wildbahn gemeldet wurde. Weitere Informationen finden Sie im [Leitfaden für Sicherheitsupdates](https://msrc.microsoft.com/update-guide).

## <a name="february-10-2022"></a>10. Februar 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version98.0.1108.50)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).

Dieses Update enthält die folgenden, Microsoft Edge-spezifischen Updates:

- [CVE-2022-23264](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-23264)

## <a name="february-3-2022"></a>3. Februar 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version98.0.1108.43)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).
...
## <a name="january-20-2022"></a>20. Januar 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version97.0.1072.69)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).

Dieses Update enthält das folgende Microsoft Edge-spezifische Update: 

- [CVE-2022-23258](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-23258)

## <a name="january-6-2022"></a>6. Januar 2022

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version97.0.1072.55)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).
...
## <a name="december-14-2021"></a>14.Dezember2021

Microsoft hat den aktuellen **Microsoft Edge Stable Channel (Version96.0.1054.57)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Dieses Update enthält einen Fix für [CVE-2021-4102](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-4102), der vom Chromium-Team als aktiver Exploit gemeldet wurde. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/ADV200002).

## <a name="december-10-2021"></a>10. Dezember 2021

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version96.0.1054.53)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).

## <a name="november-19-2021"></a>19. November 2021

Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version96.0.1054.29)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).
...
Microsoft hat den aktuellen  **Microsoft Edge Stable Channel (Version95.0.1020.40)** veröffentlicht, der die aktuellen Sicherheitsupdates des Chromium-Projekts enthält. Dieses Update enthält einen Fix für [CVE-2021-38000](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-38000) und [CVE-2021-38003](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-38003), die vom Chromium-Team als Exploit gemeldet wurden. Weitere Informationen finden Sie im [Sicherheitsupdate-Leitfaden](https://msrc.microsoft.com/update-guide).
...
## <a name="september-16-2021"></a>16. September 2021
...
## <a name="april-1-2021"></a>1. April 2021
...
## <a name="january-7-2021"></a>7. Januar 2021
...
## <a name="october-9-2020"></a>9. Oktober 2020
...
## <a name="april-23-2020"></a>23. April 2020
...
## <a name="february-20-2020"></a>20. Februar 2020
