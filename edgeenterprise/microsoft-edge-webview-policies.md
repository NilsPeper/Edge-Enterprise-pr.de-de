...
ms.locfileid: "11642941"
---
# <a name="microsoft-edge-webview2---policies"></a><span data-ttu-id="9387f-103">Microsoft Edge WebView2 –⁠ Richtlinien</span><span class="sxs-lookup"><span data-stu-id="9387f-103">Microsoft Edge WebView2 - Policies</span></span>
...
## <a name="available-policies"></a><span data-ttu-id="9387f-108">Verfügbare Richtlinien</span><span class="sxs-lookup"><span data-stu-id="9387f-108">Available policies</span></span>
...
### [*<a name="loader-override-settings"></a><span data-ttu-id="9387f-112">Einstellungen für Loader-Außerkraftsetzung</span><span class="sxs-lookup"><span data-stu-id="9387f-112">Loader Override Settings</span></span>*](#loader-override-settings-policies)
...
|[<span data-ttu-id="9387f-117">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="9387f-117">ReleaseChannelPreference</span></span>](#releasechannelpreference)|<span data-ttu-id="9387f-118">Einstellen der Präferenz für die Suchreihenfolge der Veröffentlichungskanäle</span><span class="sxs-lookup"><span data-stu-id="9387f-118">Set the release channel search order preference</span></span>|
  ...
  ## <a name="loader-override-settings-policies"></a><span data-ttu-id="9387f-119">Einstellungen für Loader-Außerkraftsetzungsrichtlinien</span><span class="sxs-lookup"><span data-stu-id="9387f-119">Loader Override Settings policies</span></span>
  ...
  ### <a name="browserexecutablefolder"></a><span data-ttu-id="9387f-121">BrowserExecutableFolder</span><span class="sxs-lookup"><span data-stu-id="9387f-121">BrowserExecutableFolder</span></span>

  #### <a name="configure-the-location-of-the-browser-executable-folder"></a><span data-ttu-id="9387f-122">Konfigurieren des Speicherorts des ausführbaren Browser-Ordners</span><span class="sxs-lookup"><span data-stu-id="9387f-122">Configure the location of the browser executable folder</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="9387f-123">Unterstützte Versionen:</span><span class="sxs-lookup"><span data-stu-id="9387f-123">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="9387f-125">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="9387f-125">Description</span></span>
...
<span data-ttu-id="9387f-128">Um den Wert für den Ordnerpfad festzulegen, geben Sie einen Wertnamen und ein Wertpaar an.</span><span class="sxs-lookup"><span data-stu-id="9387f-128">To set the value for the folder path, provide a Value name and Value pair.</span></span> <span data-ttu-id="9387f-129">Legen Sie den Wertnamen auf die Anwendungsbenutzer Modell-ID oder den Dateinamen der ausführbaren Datei fest.</span><span class="sxs-lookup"><span data-stu-id="9387f-129">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="9387f-130">Sie können den Platzhalter "\*" als Wert für alle Anwendungen verwenden.</span><span class="sxs-lookup"><span data-stu-id="9387f-130">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="9387f-131">Unterstützte Funktionen:</span><span class="sxs-lookup"><span data-stu-id="9387f-131">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="9387f-135">Datentyp:</span><span class="sxs-lookup"><span data-stu-id="9387f-135">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="9387f-137">Windows-Informationen und -Einstellungen</span><span class="sxs-lookup"><span data-stu-id="9387f-137">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="9387f-138">Informationen zur Gruppenrichtlinie (ADMX)</span><span class="sxs-lookup"><span data-stu-id="9387f-138">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="9387f-144">Windows-Registrierungseinstellungen</span><span class="sxs-lookup"><span data-stu-id="9387f-144">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="9387f-149">Beispielwert:</span><span class="sxs-lookup"><span data-stu-id="9387f-149">Example value:</span></span>
...
```
  ...
  ### <a name="releasechannelpreference"></a><span data-ttu-id="9387f-151">ReleaseChannelPreference</span><span class="sxs-lookup"><span data-stu-id="9387f-151">ReleaseChannelPreference</span></span>

  #### <a name="set-the-release-channel-search-order-preference"></a><span data-ttu-id="9387f-152">Einstellen der Präferenz für die Suchreihenfolge der Veröffentlichungskanäle</span><span class="sxs-lookup"><span data-stu-id="9387f-152">Set the release channel search order preference</span></span>

  
  
  #### <a name="supported-versions"></a><span data-ttu-id="9387f-153">Unterstützte Versionen:</span><span class="sxs-lookup"><span data-stu-id="9387f-153">Supported versions:</span></span>
  ...
  #### <a name="description"></a><span data-ttu-id="9387f-155">Beschreibung</span><span class="sxs-lookup"><span data-stu-id="9387f-155">Description</span></span>
...
<span data-ttu-id="9387f-158">Um den Wert für den bevorzugten Veröffentlichungskanal festzulegen, geben Sie einen Wertnamen und ein Wertpaar an.</span><span class="sxs-lookup"><span data-stu-id="9387f-158">To set the value for the release channel preference, provide a Value name and Value pair.</span></span> <span data-ttu-id="9387f-159">Legen Sie den Wertnamen auf die Anwendungsbenutzer Modell-ID oder den Dateinamen der ausführbaren Datei fest.</span><span class="sxs-lookup"><span data-stu-id="9387f-159">Set value name to the Application User Model ID or the executable file name.</span></span> <span data-ttu-id="9387f-160">Sie können den Platzhalter "\*" als Wert für alle Anwendungen verwenden.</span><span class="sxs-lookup"><span data-stu-id="9387f-160">You can use the "\*" wildcard as value name to apply to all applications.</span></span>
  ...
  #### <a name="supported-features"></a><span data-ttu-id="9387f-161">Unterstützte Funktionen:</span><span class="sxs-lookup"><span data-stu-id="9387f-161">Supported features:</span></span>
  ...
  #### <a name="data-type"></a><span data-ttu-id="9387f-165">Datentyp:</span><span class="sxs-lookup"><span data-stu-id="9387f-165">Data Type:</span></span>
  ...
  #### <a name="windows-information-and-settings"></a><span data-ttu-id="9387f-167">Windows-Informationen und -Einstellungen</span><span class="sxs-lookup"><span data-stu-id="9387f-167">Windows information and settings</span></span>

  ##### <a name="group-policy-admx-info"></a><span data-ttu-id="9387f-168">Informationen zur Gruppenrichtlinie (ADMX)</span><span class="sxs-lookup"><span data-stu-id="9387f-168">Group Policy (ADMX) info</span></span>
  ...
  ##### <a name="windows-registry-settings"></a><span data-ttu-id="9387f-174">Windows-Registrierungseinstellungen</span><span class="sxs-lookup"><span data-stu-id="9387f-174">Windows Registry Settings</span></span>
  ...
  ##### <a name="example-value"></a><span data-ttu-id="9387f-179">Beispielwert:</span><span class="sxs-lookup"><span data-stu-id="9387f-179">Example value:</span></span>
...
## <a name="see-also"></a><span data-ttu-id="9387f-181">Weitere Informationen</span><span class="sxs-lookup"><span data-stu-id="9387f-181">See also</span></span>
